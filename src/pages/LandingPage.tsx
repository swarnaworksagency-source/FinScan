          ...
          <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-4 px-4">
            <div className="flex-shrink-0 cursor-pointer" onClick={() => navigate('/')}>
              <img 
                ...
                alt="TruReport Logo" 
                className="h-8 md:h-10 w-200 object-contain" 
              />
            </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">Optical Character Recognition (OCR) and Sistem Analys</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
                ...
                <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
                      Upload your financial statements and get instant, comprehensive analysis using the Beneish M-Score model with Optical Character Recognition (OCR) Technology.
                    </p>
